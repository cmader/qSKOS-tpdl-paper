...
\begin{definition}[SKOS Data Model] Let R be the set of all resources, as defined in \todo{CM}{reference to Architecture of the World Wide Web, Vol. 1} and $V = (C, A, LL, LR, SR, AR)$ be a SKOS vocabulary, with
...
\item \(AR \subseteq C \times A\) being the set of \textbf{aggregation relations} associating conceptual resources with instances of aggregation and grouping resources, hence instances of \todo{CM}{?}
\end{itemize}
