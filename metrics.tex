...
\todo{BH,CM}{say that each criterions is implemented as a function that matches a set of resources in a given vocabulary V}
...
\subsubsection{Documentation Coverage}\todo{CM}{describe}
