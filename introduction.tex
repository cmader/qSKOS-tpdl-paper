...
\begin{itemize}
	...
	\item \todo{CM}{An earlier version, the STW thesaurus (8.06) contained 5 pairs of concepts with identical labels}. As a result, the auto-complete function of the online search interface at that time suggested identical entries, without giving disambiguation information.
...
\begin{itemize}
	...
	\item We identified existing \textbf{quality criteria} for controlled vocabularies by examining existing guidelines and \textbf{formalized} them into computable \textbf{quality metrics} so that they can be implemented consistently by different tools.
