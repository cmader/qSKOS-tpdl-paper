...
\begin{itemize}
	...
	\item We identified \todo{CM}{XX} \textbf{quality criteria} for SKOS vocabularies by examining existing guidelines and formalized them into computable \textbf{filtering functions} that identify possibly affected resources in a given SKOS vocabulary.
