...
The criteria defined in this section..\todo{CM}{describe}. Their filtering function \(f:V \rightarrow \mathfrak{P}(IR)\) yields all sets of \textbf{conceptual resources} violating the respective criterion.
