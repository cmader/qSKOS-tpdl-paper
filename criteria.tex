...
\todo{CM}{check top concept issue!}
...
% Function definition
It can be computed by iterating over all elements $ac \in AC$ and checking the host part of all related resource URIs \todo{CM}{authoritative concepts?}. If none of these host names differ from the host part of $ac$'s URI, it has no out-links and is thus included in the resources identified by this issue.
