...
\begin{definition}[SKOS Vocabulary] Let the fully entailed RDFS interpretation~\cite{RDFSEM2012} of a SKOS vocabulary be a tuple of of the form $V = \langle IR, C, SR, LV \rangle$, with
