...
% TODO CM: it is unclear what "mentioned" means in this context...
...
% Function definition
We provide the function \textit{mol} that iterates over all elements $c \in C$ and investigates \todo{CM}{mapping relations?} the host part of all related resource URIs. If none of these host names differ from the host part of $c$'s URI, it has no out-links and is thus included in the resources identified by this issue.
