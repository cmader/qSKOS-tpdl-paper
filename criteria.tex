...
\todo{CM}{use definition environment and find out how to turn of numbering}
...
% Origin and rationale
The ISO/DIS 25964-1 standard \cite{ISO25964-1:2011} suggests that terms that share a common broader term but do not have an \todo{CM}{explain "overlapping"}overlapping meaning, should not be related associatively. This is advocated by Hedden~\cite{Hedden2010} and Aitchison et al.~\cite{Aitchison2000} who point out ``the risk that thesaurus compilers may overload the thesaurus with valueless relationships'', having a negative effect on precision.
% Function defintion
