...
With controlled vocabularies being available in the Web of Data, they are adopted for use-cases or domains not originally intended by the creators. These use-cases often have specific and overlapping requirements regarding, e.g., structure, availability or documentation of the underlying controlled vocabularies. To give some examples, loose concepts might negatively impact retrieval recall, missing entry points to an aggregated set of concepts impedes orientation for human users, and inconsistent relations hinder queries across distinct datsets. Thus there is a need for higher-level quality criteria that go beyond the integrity conditions given in the SKOS data model, which take into account characteristics of the intended application areas. \todo{CM}{provide references}
